  ...
  return (
    <header className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1514996937319-344454492b37?q=80&w=1974&auto=format&fit=crop"
          alt="Fondo principal de Dulcesita"
          className="w-full h-full object-cover object-center"
        />

        <div className="absolute inset-0 bg-linear-to-r from-[#fff8f6]/90 via-[#fff8f6]/70 to-transparent" />
      </div>
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-6 lg:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="max-w-xl">
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-[#54433a] mb-10 leading-relaxed max-w-md">
          ...
          {/* CTA */}
          <a
            href={`https://wa.me/${51970754616}?text=${encodeURIComponent("Hola, vengo de su sitio web y quisiera más información sobre sus productos.")}`}
            target="_blank"
